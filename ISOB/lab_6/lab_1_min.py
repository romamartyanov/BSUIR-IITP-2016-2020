...
def parse_args():
 ...
 parser.add_argument('--code',type=str,default='caesar',help="'caesar' or 'vigener'")
 parser.add_argument('--mode',type=str,default='encode',help="'decode' or 'encode'")
 parser.add_argument('--input_file',type=str,default='',help='Input file path')
 parser.add_argument('--export_file',type=str,default='',help='Export file path (not existing file)')
